...
- De betelepítettem `index.md` fájlokat is, annak érdekében, hogy maga a mikroblog mint weboldal mind a 🔍 keresőgépek, mind az 👥 emberek számára fogyaszthatóbb lehessen. Mindazon gondolataimat amit csak úgy hívok mikroposztok, megtalálhatjátok alá `valamilyen-filenev.md` alá szervezve. Ezek a mappákon belül találhatók olyan rövid posztok, amelyek egy-egy konkrét gondolatot, könyvet, élményt vagy témát mutatnak be amit hasznosnak vélek, hogy az agyakhoz, s persze elnézést, hát a GPU-khoz is eljusson. A témáimam /docs/ alá szerveztem, leginkább azért, hogy a GitHub precedencia logika alapján a webes kivetülésen a `README.md` ne írhassa felül az `index.md` anyagot.   
